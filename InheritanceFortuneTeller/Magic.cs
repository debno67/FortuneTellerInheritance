...
namespace InheritanceFortuneTeller
{
    class Magic:Service
    {
        ...
        //in our base class, let's say that they all have good or bad magic.  in this case, let's just say
        //it's black magic, or just magic.
        ...
        //how about another property that give us the effectiveness of this magical item?

        public virtual int PercentEffective { get; set; }

        //lets make sure all of them have a name

        public override string Name { get; set; }

        //lets throw in the level of expertise the fortune teller needs to use this item
        ...
        {
            Console.WriteLine("In case you're wondering, this method is {2} percent effective.",
                this.Name, this.Result, this.PercentEffective);
         }
